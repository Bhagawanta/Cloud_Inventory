...
app.get('/sendmail/:name',(req,res)=>{
  ...
  let info = transporter.sendMail({
    from: '"Cloud Support Team" <Supportcloud-pune@gov.in>', // sender address
    to: "Supportcloud-pune@gov.in", // list of receivers
    subject: "Inventory System Alert", // Subject line
    // text: "Hello Tejas", // plain text body
    html: 
    `<html>
     <body>
     <h2>Inventory Alert</h2>
     <h3>The ${req.params.name} item has been expire in few days</h3>
     </body>
     </html>
    `, // html body
  });
